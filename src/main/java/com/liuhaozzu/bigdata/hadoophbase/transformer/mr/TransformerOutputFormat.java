package com.liuhaozzu.bigdata.hadoophbase.transformer.mr;
...
import com.liuhaozzu.bigdata.hadoophbase.transformer.service.impl.DimensionConverterImpl;
import com.liuhaozzu.bigdata.hadoophbase.util.JdbcManager;

/**
 * 自定义输出到mysql的outputformat类 BaseDimension:reducer输出的key
